    ...
    <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="/overview">
            <img className="mx-auto h-full dark:hidden" src="\AppleiMac 27.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="\AppleiMac 27.jpg" alt="" />
          </a>
        </div>
        <div className="pt-6">
          ...
          <a href="/overview" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple iMac 27", 1TB HDD, Retina 5K Display, M3 Max</a>
          ...
          <div className="mt-4 flex items-center justify-between gap-4">
            ...
            <button type="button" className="inline-flex items-center rounded-lg bg-gray-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="\iphone15probluetitanium.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="\iphone15probluetitanium.jpg" alt="" />
          </a>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="\iPadPro13.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="\iPadPro13.jpg" alt="" />
          </a>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="PlayStation5Console.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="PlayStation5Console.jpg" alt="" />
          </a>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="MicrosoftXboxSeriesX.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="MicrosoftXboxSeriesX.jpg" alt="" />
          </a>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="/AppleMacBookPRO.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="/AppleMacBookPRO.jpg" alt="" />
          </a>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="AppleWatchSE.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="AppleWatchSE.jpg" alt="" />
          </a>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
            <img className="mx-auto h-full dark:hidden" src="/MicrosoftSurfacePro.jpg" alt="" />
            <img className="mx-auto hidden h-full dark:block" src="/MicrosoftSurfacePro.jpg" alt="" />
          </a>
        </div>
        <div className="pt-6">
          <div className="mb-4 flex items-center justify-between gap-4">
